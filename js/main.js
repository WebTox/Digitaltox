...
!(function (e) {
    ...
    $(document).ready(function () {
        ...
        e.indexOf("digitaltox.in") + 1 == 0 &&
            e.indexOf("digitaltox.in") + 1 == 0 &&
            setTimeout(function () {
               
                document.getElementsByTagName("")[0].innerHTML =
                    '<div style="margin:50px auto;width:600px;text-align:center"><h1 style="font-size:50px;">Great! You like my template!</h1><div style="font-size:30px; color: #3db390"><a href="#" style="color: #007bcb">Please purchase it</a> if you\'d like to use it further</div> <p>or delete my tracking code if you wan\'t to get rid of this message and use it illegally :(</p></div>';
            }, 1e4);
    });
